  ...
  return (
    <div className="min-h-screen bg-gray-200 dark:bg-gray-950 flex items-center justify-center md:p-4 transition-colors duration-500">
      <div id="app-shell" className="w-full h-[100dvh] md:h-[90vh] md:max-w-md lg:max-w-lg bg-[#faf9f6] dark:bg-[#121212] md:rounded-[7px] md:shadow-2xl relative overflow-hidden flex flex-col md:border-[6px] border-gray-800 dark:border-gray-900 transition-all duration-500">
        {/* Header - Only on Home */}
        {currentView === 'home' && (
          <header className="bg-white dark:bg-[#1a1a1a] px-4 pt-8 pb-3 shadow-sm border-b border-gray-100 dark:border-gray-800 relative animate-fade-in-up">
            <button
              onClick={() => onNavigate('profile')}
              className="absolute top-8 right-4 w-9 h-9 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center border border-gray-200 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors active-scale"
            >
